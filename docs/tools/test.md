...
Full tool reference and per-arg details: see the [plugin README in the repo](https://github.com/bluesteelll/ue5-mcp-bridge/blob/main/README.md#test).
...
print([h for h in all_handlers if h.startswith("test.")])
```
